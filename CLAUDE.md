...
| **Compiled blueprints** | `web/public/blueprints/` | LogicFlowModel JSON, generated by `leapter convert` and served as `/blueprints/...` static assets (gitignored) |
...
| **Browser runtime** | `packages/runtime-browser/` | `@leapter/runtime-browser` - executes an in-memory Project via QuickJS WASM |
...
│   └── public/blueprints/             ← Compiled blueprint JSON served at /blueprints/ (gitignored)
├── packages/
